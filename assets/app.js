...
async function convertLink() {
  ...
  try {
    ...
    try {
      ...
      throw new Error('La API non ha restituito JSON. Risposta ricevuta: ' + raw.substring(0, 200));
    }
    ...
    showResult(`
      ...
      Prezzo letto da Amazon: € ${Number(data.product_price).toFixed(2)}<br>
      ...
      Tag principale: ${data.tag}<br>
      Subtag utente: ${data.subtag}<br><br>
